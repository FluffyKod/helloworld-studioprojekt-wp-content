...
wp_localize_script('stm-lms-add_students/main', 'stm_lms_add_students', array(
    'translations' => array(
        'choose_course' => esc_html__('Please select course', 'masterstudy-lms-learning-management-system-pro'),
        'choose_students' => esc_html__('Please select students', 'masterstudy-lms-learning-management-system-pro'),
    )
));
...
wp_localize_script('stm-lms-enterprise-groups', 'stm_lms_groups', array(
    'limit' => 0,
    'translations' => array(
        'group_limit' => esc_html__('Limit:', 'masterstudy-lms-learning-management-system-pro'),
    )
));
...
<div class="stm_lms_add_student__fields">
    ...
    <div id="stm_lms_add_students_to_course">
        ...
        <div class="stm_lms_add_students_to_course">
            ...
            <h2><?php esc_html_e('Add student', 'masterstudy-lms-learning-management-system-pro'); ?></h2>
    ...
    <div class="stm_lms_add_student__fields_wrapper">
        ...
        <div id="stm_lms_enterprise_groups" v-bind:class="{'loading': loading}">
            ...
            <div class="stm_lms_ent_groups_add_edit__emails">
                ...
                <h4><?php esc_html_e('Type students emails', 'masterstudy-lms-learning-management-system-pro'); ?></h4>
